...
#include <NTPClient.h>
WiFiUDP ntpUDP;
NTPClient timeClient(ntpUDP, "europe.pool.ntp.org", 3600, 60000); //WiFiUPD, Offset in sec, Updateintervall in sec
...
//////////////////////////////////////////////////// Variablen
//////////////////////////////////////////////////////////////////////////////Eingabe
byte tempMin = 45; //minimal Temperatur
byte tempMax = 85;
...
void timer(){
  ...
  if (timerStart1 && tempSollErreicht && !timerEnde) { //Verstellt den Timer wenn Automatik 
    if (!timerInt) {
      timerGo = now.secondstime();
      timer0 = timerSet;
      timerInt = true;
    }
    int timerDelta = now.secondstime() - timerGo;
...
void hopfentimer(){
  ...
  if (timerHopfenStart && tempSollErreicht && !timerHopfenEnde) { //Verstellt den Timer wenn Automatik 
    if (!timerHopfenInt) {
      timerHopfenGo = now.secondstime();
      timerHopfen0 = timerHopfenSet;
      timerHopfenInt = true;
    }
    int timerDelta = now.secondstime() - timerHopfenGo;
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (hMenueON && !thingspeakData) { //hauptmenü
              ...
              client.print("<h3>Aktionen:</h3>");
              client.print("<form> <button formaction=\"/otaupdate\"style=\"width:150px;background-color:orange\">OTA Update</button></form>");
              client.print("<p style =\"font-size:8pt\">(nach dem Klick auf \"OTA Update\" <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; bitte <a href=\"/update\">HIER</a> klicken)</p>");
              ...
              client.print("<h3>Danger Zone:</h3>");
              ...
              client.print("&nbsp;<br>");
              client.print("&nbsp;<br>");
              client.print("<p style =\"font-size:8pt\">Firmware Vers. ");
              client.print(software);
              client.print("<br><a href=\"/\">AKTUALISIEREN</a>");
              client.print("</p>"); 
              ...
              //client.print("</TITLE><meta http-equiv='refresh'content=\"30; URL=/\">");
              client.print("<form> <button formaction=\"/zurueck\" style=\"background-color:red\">Zurueck</button></form>");
              client.print("<h1>thingspeak.com Zugangsdaten</h1>");
              client.print("&nbsp;<br>");
